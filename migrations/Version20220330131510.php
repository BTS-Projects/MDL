 ...
 */
final class Version20220330131510 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        //$this->addSql('ALTER TABLE atelier DROP idtheme, DROP idinscription');
